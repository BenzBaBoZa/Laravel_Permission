                            ...
                            <form action="{{ route('register.save') }}" method="POST" class="user">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input name="password_confirmation" type="password" class="form-control form-control-user @error('password_confirmation')is-invalid @enderror" id="exampleInputPassword_Confirmation" placeholder="Password Confirmation">
